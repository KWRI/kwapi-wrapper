    ...
    describe('testRegister()', () => {
        xit('Should register an Event data', (done) => {
            const requestObject = {
                ...
                action: 'delete',
                version: 21,
                jasonSchema: '{"$schema":"http://json-schema.org/draft-04/schema#","type":"object","properties":{"name":{"type":"string"},"object":{"type":"string"},"action":{"type":"string"},"createdAt":{"type":"string"}},"required":["name","object","action","createdAt"]}'
            }
