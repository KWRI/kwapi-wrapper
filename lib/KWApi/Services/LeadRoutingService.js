...
class LeadRoutingService extends AbstractService {
    ...
    */
    lists(queryData) {
        const hasQueryData = !!queryData;
        const query = hasQueryData ? queryData : {};
    ...
    */
    /* eslint-disable */
    createAgent(id, name, kw_uid, email, active) {
    ...
    * @return \KWApi\Models\Response
    */
    respondAssignment(leadId, respondBool) {
        respondBool = typeof respondBool === "undefined" ? true : respondBool;
